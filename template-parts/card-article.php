...
<article id="post-<?php the_ID(); ?>" <?php post_class('article-card bg-white overflow-hidden group relative'); ?>>
    ...
    <div class="thumb relative">
        ...
        <div class="categories absolute bottom-0 right-0 font-medium text-4xl flex flex-col items-end opacity-0 transform translate-y-2 transition-[opacity,translate] duration-300 group-hover:opacity-100 group-hover:translate-y-0 z-20">
