...
<div id="comments" class="comments-area container mx-auto py-8">
    ...
    $comments_args = array(
        ...
        'submit_button'        => '<button type="submit" class="w-full text-black font-bold py-4 px-6 bg-gold hover:bg-darkgold hover:text-white transition-colors">PUBLICAR EL COMENTARIO</button>',
