  ...
  <section class="newsletter block my-8 mx-auto bg-gris">
    <div class="container mx-auto text-white px-5 py-5 lg:px-50 lg:py-[70px]">
      ...
      <form class="pt-7.5 flex flex-wrap justify-center items-center">
        ...
        <button
          class="w-[200px] py-2.5 px-2.5 text-base bg-darkgold border-none text-black font-bold uppercase transition-colors duration-300 hover:cursor-pointer hover:bg-gold">
          Enviar
        </button>
      </form>
    </div>
